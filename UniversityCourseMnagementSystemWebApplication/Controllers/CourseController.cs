...
namespace UniversityCourseMnagementSystemWebApplication.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Code,credit,DepartmentId,SemesterId,IsActive")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Code,credit,DepartmentId,SemesterId,IsActive")] Course course)
        {
            if (ModelState.IsValid)
            {
