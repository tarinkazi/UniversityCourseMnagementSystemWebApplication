...
namespace UniversityCourseMnagementSystemWebApplication.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,ContactNo,DesignationId,DepartmentId,Address,Email,CreditTaken")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,ContactNo,DesignationId,DepartmentId,Address,Email,CreditTaken")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
